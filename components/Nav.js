            ...
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="#" className="flex">
                        ...
                        <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">We Teach Frontend</span>
                    </a>
                    <div className="flex items-center md:order-2">
                        <button onClick={toggleOpen} type="button" className="flex mr-3 text-sm bg-independence rounded-full md:mr-0 focus:ring-1 focus:ring-ring-inset dark:focus:ring-ring-inset" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
