...
export default function ReactPage() {
    ...
    /* const fetcher = url => axios.get(url).then(res => setState(res.data)); */
    ...
    if (!data) return <div style={{ padding: `35vw 45vw` }}><ProgressSpinner /></div>
        ...
        <>
            <Container>
                ...
                <div className='flex w-70 justify-around'>
                    <button value="All" onClick={handleBtns}>Reset</button>
